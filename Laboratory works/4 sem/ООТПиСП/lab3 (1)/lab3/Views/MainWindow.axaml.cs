...
namespace lab3.Views
{
    public partial class MainWindow : Window
    {
        ...
        protected override void OnPointerPressed(PointerPressedEventArgs e)
        {
            ...
            if (e.GetCurrentPoint(this).Properties.IsLeftButtonPressed)
            {
                if (!_isFirstPoint)
                {
                    ...
                    {
                        _isFirstPoint = false;
                        var newShape = _shapeFactory.GetShapeByNumber( (int) _mode);
                        _shapeList.Add(newShape(_p1, _p2, this._color, this._thickness));
        ...
        private void Redraw()
        {
            ...
            {
                var newShape = _shapeFactory.GetShapeByNumber( (int) _mode);;
                _shapePreviewList.Add(newShape(_p1, _p2, this._color, this._thickness));
            }
