...
HD_PWD='D:/Work/testsdfsdfsdfsdsfdsfd/testsdfsdfsdfsdsfdsfd.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log MY_LUT5.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source MY_LUT5.tcl
